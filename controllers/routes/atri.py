...
class Atri:
	def __init__(self, state: Any):
		...
		self.nav_holder = state["nav_holder"]
		self.nav_menus = state["nav_menus"]
		self.Flex_holder = state["Flex_holder"]
		self.site_img_holder = state["site_img_holder"]
		self.hero_sec = state["hero_sec"]
		self.hero_img_holder = state["hero_img_holder"]
		self.hero_info = state["hero_info"]
		self.Div5 = state["Div5"]
		self.Div6 = state["Div6"]
		self.Flex9 = state["Flex9"]
		self.Flex10 = state["Flex10"]
		self.trusted_by = state["trusted_by"]
		self.trust_img_holder = state["trust_img_holder"]
		self.Div86 = state["Div86"]
		self.Div87 = state["Div87"]
		self.Div88 = state["Div88"]
		self.Div89 = state["Div89"]
		self.service = state["service"]
		self.service_info = state["service_info"]
		self.services_holder = state["services_holder"]
		...
		self.flex_project = state["flex_project"]
		self.Div25 = state["Div25"]
		self.projects_holder = state["projects_holder"]
		...
		self.product_desinger = state["product_desinger"]
		self.product_info = state["product_info"]
		self.Div32 = state["Div32"]
		self.product_imgs = state["product_imgs"]
		...
		self.faq_holders = state["faq_holders"]
		...
		self.testimonial_info = state["testimonial_info"]
		...
		self.blog_info = state["blog_info"]
		self.Div71 = state["Div71"]
		self.Flex49 = state["Flex49"]
		self.blogs_example = state["blogs_example"]
	...
	@property
	def nav_holder(self):
		self._getter_access_tracker["nav_holder"] = {}
		return self._nav_holder
	@nav_holder.setter
	def nav_holder(self, new_state):
		self._setter_access_tracker["nav_holder"] = {}
		global default_state
		self._nav_holder = Flex(new_state, default_state["nav_holder"])

	@property
	def nav_menus(self):
		self._getter_access_tracker["nav_menus"] = {}
		return self._nav_menus
	@nav_menus.setter
	def nav_menus(self, new_state):
		self._setter_access_tracker["nav_menus"] = {}
		global default_state
		self._nav_menus = Flex(new_state, default_state["nav_menus"])

	@property
	def Flex_holder(self):
		self._getter_access_tracker["Flex_holder"] = {}
		return self._Flex_holder
	@Flex_holder.setter
	def Flex_holder(self, new_state):
		self._setter_access_tracker["Flex_holder"] = {}
		global default_state
		self._Flex_holder = Flex(new_state, default_state["Flex_holder"])

	@property
	def site_img_holder(self):
		self._getter_access_tracker["site_img_holder"] = {}
		return self._site_img_holder
	@site_img_holder.setter
	def site_img_holder(self, new_state):
		self._setter_access_tracker["site_img_holder"] = {}
		global default_state
		self._site_img_holder = Flex(new_state, default_state["site_img_holder"])

	@property
	def hero_sec(self):
		self._getter_access_tracker["hero_sec"] = {}
		return self._hero_sec
	@hero_sec.setter
	def hero_sec(self, new_state):
		self._setter_access_tracker["hero_sec"] = {}
		global default_state
		self._hero_sec = Flex(new_state, default_state["hero_sec"])

	@property
	def hero_img_holder(self):
		self._getter_access_tracker["hero_img_holder"] = {}
		return self._hero_img_holder
	@hero_img_holder.setter
	def hero_img_holder(self, new_state):
		self._setter_access_tracker["hero_img_holder"] = {}
		global default_state
		self._hero_img_holder = Flex(new_state, default_state["hero_img_holder"])

	@property
	def hero_info(self):
		self._getter_access_tracker["hero_info"] = {}
		return self._hero_info
	@hero_info.setter
	def hero_info(self, new_state):
		self._setter_access_tracker["hero_info"] = {}
		global default_state
		self._hero_info = Div(new_state, default_state["hero_info"])
	...
	@property
	def trust_img_holder(self):
		self._getter_access_tracker["trust_img_holder"] = {}
		return self._trust_img_holder
	@trust_img_holder.setter
	def trust_img_holder(self, new_state):
		self._setter_access_tracker["trust_img_holder"] = {}
		global default_state
		self._trust_img_holder = Flex(new_state, default_state["trust_img_holder"])
	...
	def service_info(self):
		self._getter_access_tracker["service_info"] = {}
		return self._service_info
	@service_info.setter
	def service_info(self, new_state):
		self._setter_access_tracker["service_info"] = {}
		global default_state
		self._service_info = Flex(new_state, default_state["service_info"])

	@property
	def services_holder(self):
		self._getter_access_tracker["services_holder"] = {}
		return self._services_holder
	@services_holder.setter
	def services_holder(self, new_state):
		self._setter_access_tracker["services_holder"] = {}
		global default_state
		self._services_holder = Flex(new_state, default_state["services_holder"])
	...
	def project(self, new_state):
		...
		global default_state
		self._project = Div(new_state, default_state["project"])

	@property
	def flex_project(self):
		self._getter_access_tracker["flex_project"] = {}
		return self._flex_project
	@flex_project.setter
	def flex_project(self, new_state):
		self._setter_access_tracker["flex_project"] = {}
		global default_state
		self._flex_project = Flex(new_state, default_state["flex_project"])
	...
	@property
	def projects_holder(self):
		self._getter_access_tracker["projects_holder"] = {}
		return self._projects_holder
	@projects_holder.setter
	def projects_holder(self, new_state):
		self._setter_access_tracker["projects_holder"] = {}
		global default_state
		self._projects_holder = Div(new_state, default_state["projects_holder"])
	...
	@property
	def product_desinger(self):
		self._getter_access_tracker["product_desinger"] = {}
		return self._product_desinger
	@product_desinger.setter
	def product_desinger(self, new_state):
		self._setter_access_tracker["product_desinger"] = {}
		global default_state
		self._product_desinger = Div(new_state, default_state["product_desinger"])

	@property
	def product_info(self):
		self._getter_access_tracker["product_info"] = {}
		return self._product_info
	@product_info.setter
	def product_info(self, new_state):
		self._setter_access_tracker["product_info"] = {}
		global default_state
		self._product_info = Flex(new_state, default_state["product_info"])
	...
	@property
	def product_imgs(self):
		self._getter_access_tracker["product_imgs"] = {}
		return self._product_imgs
	@product_imgs.setter
	def product_imgs(self, new_state):
		self._setter_access_tracker["product_imgs"] = {}
		global default_state
		self._product_imgs = Flex(new_state, default_state["product_imgs"])
	...
	def work(self, new_state):
		...
		global default_state
		self._work = Div(new_state, default_state["work"])
	...
	def faq(self, new_state):
		...
		global default_state
		self._faq = Div(new_state, default_state["faq"])
	...
	@property
	def faq_holders(self):
		self._getter_access_tracker["faq_holders"] = {}
		return self._faq_holders
	@faq_holders.setter
	def faq_holders(self, new_state):
		self._setter_access_tracker["faq_holders"] = {}
		global default_state
		self._faq_holders = Flex(new_state, default_state["faq_holders"])
	...
	@property
	def testimonial_info(self):
		self._getter_access_tracker["testimonial_info"] = {}
		return self._testimonial_info
	@testimonial_info.setter
	def testimonial_info(self, new_state):
		self._setter_access_tracker["testimonial_info"] = {}
		global default_state
		self._testimonial_info = Flex(new_state, default_state["testimonial_info"])
	...
	@property
	def blog_info(self):
		self._getter_access_tracker["blog_info"] = {}
		return self._blog_info
	@blog_info.setter
	def blog_info(self, new_state):
		self._setter_access_tracker["blog_info"] = {}
		global default_state
		self._blog_info = Flex(new_state, default_state["blog_info"])
	...
	@property
	def blogs_example(self):
		self._getter_access_tracker["blogs_example"] = {}
		return self._blogs_example
	@blogs_example.setter
	def blogs_example(self, new_state):
		self._setter_access_tracker["blogs_example"] = {}
		global default_state
		self._blogs_example = Div(new_state, default_state["blogs_example"])
	...
	def menu1(self, new_state):
		...
		global default_state
		self._menu1 = Link(new_state, default_state["menu1"])
	...
	def menu2(self, new_state):
		...
		global default_state
		self._menu2 = Link(new_state, default_state["menu2"])
	...
	def menu3(self, new_state):
		...
		global default_state
		self._menu3 = Link(new_state, default_state["menu3"])
	...
	def menu4(self, new_state):
		...
		global default_state
		self._menu4 = Link(new_state, default_state["menu4"])
	...
	def menu5(self, new_state):
		...
		global default_state
		self._menu5 = Link(new_state, default_state["menu5"])
	...
	@property
	def site_img(self):
		self._getter_access_tracker["site_img"] = {}
		return self._site_img
	@site_img.setter
	def site_img(self, new_state):
		self._setter_access_tracker["site_img"] = {}
		global default_state
		self._site_img = Image(new_state, default_state["site_img"])
	...
	def _to_json_fields(self):
		return {
			"nav_holder": self._nav_holder,
			"nav_menus": self._nav_menus,
			"Flex_holder": self._Flex_holder,
			"site_img_holder": self._site_img_holder,
			"hero_sec": self._hero_sec,
			"hero_img_holder": self._hero_img_holder,
			"hero_info": self._hero_info,
			"Div5": self._Div5,
			"Div6": self._Div6,
			"Flex9": self._Flex9,
			"Flex10": self._Flex10,
			"trusted_by": self._trusted_by,
			"trust_img_holder": self._trust_img_holder,
			"Div86": self._Div86,
			"Div87": self._Div87,
			"Div88": self._Div88,
			"Div89": self._Div89,
			...
			"services_holder": self._services_holder,
			"Div10": self._Div10,
			"Flex14": self._Flex14,
			"Flex15": self._Flex15,
			"Flex17": self._Flex17,
			...
			"flex_project": self._flex_project,
			"Div25": self._Div25,
			"projects_holder": self._projects_holder,
			"Flex60": self._Flex60,
			"Div79": self._Div79,
			"Flex61": self._Flex61,
			"Div80": self._Div80,
			...
			"Flex65": self._Flex65,
			"Flex66": self._Flex66,
			"product_desinger": self._product_desinger,
			"product_info": self._product_info,
			"Div32": self._Div32,
			"product_imgs": self._product_imgs,
			"Div33": self._Div33,
			"Div34": self._Div34,
			"Flex27": self._Flex27,
			...
			"testimonial_info": self._testimonial_info,
			"Div83": self._Div83,
			"Flex68": self._Flex68,
			"Div84": self._Div84,
			"Flex69": self._Flex69,
			...
			"Div71": self._Div71,
			"Flex49": self._Flex49,
			"blogs_example": self._blogs_example,
			"Div73": self._Div73,
			"Flex50": self._Flex50,
			"Flex51": self._Flex51,
			"Div75": self._Div75,
