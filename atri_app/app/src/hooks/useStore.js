...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Accordion7": {
      "custom": {
        "title": [
          "What you use to measure success?"
        ],
        "description": [
          " I usually work on B2C software, that's my forte--where I shine best. But I also have about 15 B2B software products in my portfolio. I do end-to-end product design + branding."
        ],
    ...
    "TextBox73": {
      "custom": {
        "text": "© All rights reserved. Conversionflow. Powered by Webflow / Image License Info / Instructions / Changelog / Style Guide (Clone by srijita)"
      },
      "callbacks": {
        "onClick": [
          {
